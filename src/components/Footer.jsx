        ...
        <div className="row g-5">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <p className="mb-2">
              ...
              123 Woodside Lane, Oak Park Near Hillview Circle, Dehradun — 248001
            </p>
            <p className="mb-2">
        ...
        <div className="copyright">
          <div className="row">
            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
             ...
             The Woodside Café is a hospitality brand based in India, bringing people together over great coffee and cozy vibes.
